...
//            sauvegarde du résultat dans les logs
                        ...
                        AddTransaction($partnerId, null, $serviceId, "SEND MONEY", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 101, $langFront["Label"][18], $langFront["Label"][18], $reference_id, null, 1, $connection);
