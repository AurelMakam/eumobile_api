        ...
        if ($informix != -1) {
            foreach ($data as $onecashin) {
                ...
                if (is_null($subsdetails)) {
                    AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 200, $langFront["Label"][21], $langFront["Label"][21], $reference_id, null, 1, $connection);
                    ...
                    AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 101, $langFront["Label"][18], $langFront["Label"][18], $reference_id, null, 1, $connection);
                    ...
                    if (!preg_match("/$plan/", PLAN_PREMIUM)) {
                        AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 101, $langFront["Label"][23], $langFront["Label"][23], $reference_id, null, 1, $connection);
                        ...
                        AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 101, $langFront["Label"][24], $langFront["Label"][24], $reference_id, null, 1, $connection);
                        ...
                        if ($url == "-1") {
                            AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 405, $langFront["Label"][15], $langFront["Label"][15], $reference_id, null, 1, $connection);
                            ...
                            AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 404, $langFront["Label"][9], $langFront["Label"][9], $reference_id, null, 1, $connection);
...
//                            saveRequest($serviceId, $partnerId, $m_hash, $amount, 1, $connection);
                                    ...
                                    if (!is_null($transdetails) && $transdetails != -1) {
                                        ...
                                        AddTransaction($partnerId, $transaction, $serviceId, "BULK CASH IN", $partnerCode, $transdetails["destination"], $transdetails["amount"], $transdetails["fee"], $transdetails["tax"], $transdetails["date"], $transdetails["result_code"], $transdetails["result_desc"], $transaction, $reference_id, $commission, 0, $connection);
                                        ...
                                        AddTransaction($partnerId, $transaction, $serviceId, "BULK CASH IN", $partnerCode, $phone, $tab[0], "", "", $date . " " . $time, 0, $langFront["Label"][7], $transaction, $reference_id, null, 0, $connection);
                                    ...
                                    AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", $partnerCode, $phone, $amount, 0, 0, $date . " " . $time, 101, $result, $result, $reference_id, null, 1, $connection);
            ...
            AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", null, $phone, $amount, 0, 0, $date . " " . $time, 101, $langFront["Label"][18], $langFront["Label"][18], "", null, 1, $connection);
        ...
        AddTransaction($partnerId, null, $serviceId, "BULK CASH IN", null, $phone, $amount, 0, 0, $date . " " . $time, 405, $langFront["Label"][8], $langFront["Label"][8], "", null, 1, $connection);
