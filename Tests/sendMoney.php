                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" id="formnewmerchant" action="http://localhost/eumobile_api/sendMoney" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label>Numéro Bénéficiaire 237xxxxxxxx </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Montant du transfert</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Devise</label>
