...
// Sending the request ad getting the result
        ...
        if ($url == "-1") {
            ...
            if (Addbill($partnerId, $reference, $amount, $date, $date, $phone, $phone, $custname, " ", "CASHOUT", $m_hash, 0, $connection)) {
...
//                    récuperation du timeout du partenaire
                            ...
                            /**
                             * Envoi de la requete au serveur vocal
                             */
                            $transaction = $tab[1];
                            ...
                            $json  = json_encode(array("accountNumber" => $phone));
                            managerLogSimple(__FILE__, __CLASS__, $ip, $partnerId, $service, "json data = " . $json );
                            makeCall($json, CALL_GATEWAY, $transaction, $connection) ;
