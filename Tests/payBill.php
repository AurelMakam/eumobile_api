                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" id="formnewmerchant" action="http://localhost/eumobile_api/payBill" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label>Facturier (Partenaire)</label>
                                        <input class="form-control"  name="biller" id="biller">
                                        <p class="help-block">ENEO/CDE/...</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Numéro Facture</label>
                                        <input class="form-control"  name="billno" id="billno">
                                        <p class="help-block">Numéro Facture</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Hash</label>
