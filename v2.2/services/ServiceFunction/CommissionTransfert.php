...
//                            saveRequest($serviceId, $partnerId, $m_hash, $amount, 1, $connection);
                                ...
                                if (!is_null($transdetails) && $transdetails != -1) {
                                    AddCommissionTransaction($partnerId, $transaction, $transdetails["source"], $transdetails["destination"], $transdetails["amount"], $transdetails["fee"], $transdetails["tax"], $transdetails["date"], 1, $transdetails["result_desc"]. ":" . $translist, $connection);
                                    ...
                                    AddCommissionTransaction($partnerId, $transaction, $WalletCode, $partnerCode, $tab[0], "", "", $date . " " . $time, 1, $langFront["Label"][7]. " : " . $translist, $connection);
